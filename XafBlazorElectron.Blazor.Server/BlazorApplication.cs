...
using XafBlazorElectron.Blazor.Server.Services;


namespace XafBlazorElectron.Blazor.Server {
    public partial class XafBlazorElectronBlazorApplication : BlazorApplication {
        public XafBlazorElectronBlazorApplication() {
            InitializeComponent();
        }
        protected override void OnSetupStarted() {
            ...
            if(configuration.GetConnectionString("ConnectionString") != null) {
                ConnectionString = InMemoryDataStoreProvider.ConnectionString;//configuration.GetConnectionString("ConnectionString");
            }
#if EASYTEST
        ...
        private void XafBlazorElectronBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
//#if EASYTEST
//            e.Updater.Update();
//            e.Handled = true;
//#else
